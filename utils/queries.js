...
var RETRIEVE_LIST_OF_STUDENTS_SINGLE = `SELECT student_email FROM ${STUDENT_TO_TEACHER_DATABASE} WHERE teacher_email IN (?)`;

var RETRIEVE_LIST_OF_STUDENTS_MULTIPLE_1 = `SELECT student_email FROM ${STUDENT_TO_TEACHER_DATABASE} WHERE teacher_email NOT IN (?)`;
module.exports.RETRIEVE_LIST_OF_STUDENTS_MULTIPLE_1 = RETRIEVE_LIST_OF_STUDENTS_MULTIPLE_1;

var RETRIEVE_LIST_OF_STUDENTS_MULTIPLE_2 = `SELECT student_email FROM ${STUDENT_TO_TEACHER_DATABASE} WHERE teacher_email NOT IN (?)`;
...
var CHECK_FOR_SUSPENDED_STUDENT = `SELECT COUNT(*) as count_value FROM ${SCHOOL_DATABASE} WHERE email = ? AND user_status = ?`;
...
var CHECK_FOR_VALID_STUDENT = `SELECT COUNT(*) as count_value0 FROM ${SCHOOL_DATABASE} WHERE email = ?`;
