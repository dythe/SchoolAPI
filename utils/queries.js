...
var RETRIEVE_LIST_OF_STUDENTS_MULTIPLE = `SELECT student_email FROM ${STUDENT_TO_TEACHER_DATABASE} WHERE teacher_email NOT IN (?)`;
...
module.exports.RETRIEVE_LIST_OF_STUDENTS_MULTIPLE = RETRIEVE_LIST_OF_STUDENTS_MULTIPLE;
